I had made this project committee system where we can organinse the committees like (kitty party, etc)
...
first run command npm i in terminal for both frontend and backend (installation)
